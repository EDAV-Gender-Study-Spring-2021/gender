...
Question 1: How do social status of women compare to men in modern society from a variety of standpoints like social rights, education and employment?

Question 2: How has social status of women changed in the last few years regarding social rights, education and employment?

Question 3: What are the differences and developments in social status of women between different countries in recent years? Does GDP (or other developmental/ geographical factors) have an influence on the changes? How to explain the status differences from the perspective of different countries?
...
(The font size in the interactive parallel coordinates can not be changed. We tried to make the figure large so that it will be clearer.)
...
First, we want to focus on the difference between female and male in education status, thus using a bar plot is a good choice as it clearly shows the differences between these two groups in each category. This bar plot shows the proportion in female and male population over 25 years old based on education levels they at least complete. I divide the education levels into three categories: primary(grade 1-6), lower secondary(grade 7-12) and post secondary(all education after high school). In order to reduce the influences of missing values, I take the average of 30 countries in our sample during the recent 10 years. Thus this plot shows the overall education status in female and male population instead of focusing on a specific location or a specific year. 

By observing the plot, the proportion decreases for both female and male population as the education level becomes higher. Over 80 percent female and male complete at least a primary level education, and over 60 percent of each population complete at least the lower secondary, while only less than 30 percent complete the post secondary education. This observation is consistent with our common sense: there will be less proportion of people in higher education. 

Moreover,  the data of female and male groups tend to have small difference in all three education levels. In the first two categories, primary and lower education, male population shows higher proportion of people complete this education level than female population, whereas in the last category, the plot shows there are higher proportion of female who graduates from a post secondary school than males. If we look at the scale of difference in the first two group, the difference in the lower secondary is smaller than the difference in primary. Thus, based on these two observations, we find that males tend to have more opportunities to take a basic level education than females. Also, among the population that complete the previous level of education, relative more females complete the next level education than males.
