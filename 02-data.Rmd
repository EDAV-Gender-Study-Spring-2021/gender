...
We have a big data file, which has 164,112 rows and 66 columns. Each entry represents a single indicator for a country. In total, we have 263 countries and each has 624 different indicators. One indicator is a record item, eg. GDP, and have numeric data recored from 1960 to 2020. In each row, it has 4 string variables: country name, country code, a description of indicator and indicator code. The indicators have a “boolean” form like the yes or no statement, with the numeric data entries 1 as yes, 0 as no. The indicators can be categorized into 5 types. 
